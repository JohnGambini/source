    ...
    ui(new Ui::MainWindow)
{
    ...
    m_applicationName = "TaDa Sequencer";
    m_windowTitle = "TaDa Sequencer[*]";
    gnaVariant data = "Sequence List";
...
void MainWindow::doClear()
{
    ...
    m_Root.setData(0,data);
    m_projectView->setRoot(&m_Root);
    m_sequencerView->setRoot(NULL);
    //m_sequencerView->clear();
    //m_filePath = "";
...
{
    QMessageBox::about(this, tr("About Sequencer"),
             tr("The TaDa <b>Sequencer</b>. This is version 0.00001"));
